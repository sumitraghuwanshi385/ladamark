...
const SignUpPage: React.FC<SignUpPageProps> = ({ onClose, onSwitchToLogin }) => {
  ...
  // Freeze background scrolling when register modal is active
  useEffect(() => {
  ...
  // Helper function to save user data to Firestore safely
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center mt-6">
           <Logo />
           <h2 className="text-[26px] md:text-[28px] font-bold text-zinc-900 dark:text-white tracking-tight">Create Account</h2>
           <p className="text-[13.5px] md:text-[14px] text-zinc-600 dark:text-zinc-400 mt-1 mb-8">Start your journey with Ladamark.</p>
        </div>
        ...
        <div className="relative z-10">
            ...
            {/* Account Toggle Option section links to login modal natively */}
